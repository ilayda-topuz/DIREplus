...
class TrainLoop:
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            # Added micro1 for original images
            micro1 = batch[i : i + self.microbatch].to(dist_util.dev())
            micro = self.get_first_stage_encoding(micro1).detach()
            micro_cond = {
            ...
            # Added class_cond and original_images to micro_cond
            micro_cond['original_images']=micro1
            micro_cond['class_cond']=self.class_cond
